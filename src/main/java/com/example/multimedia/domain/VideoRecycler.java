...
public class VideoRecycler{
    ...
    public VideoRecycler(){
        this.date = new Date();
    }

    public VideoRecycler(String title,String tpinyin,String image,String summary,String url,String type,Date date){
        this.title = title;
