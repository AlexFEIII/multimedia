  ...
  (f.prototype = {
    ...
    show: function (H) {
      ...
      if (!(K.indexOf(t) >= 0)) {
        ...
        var s = o('<div class="close_top_div"><a href="javascript:;"><i class="w-e-icon-close w-e-panel-close"></i></a><div>');
        c.append(s),
        ...
        l = new f(this, {
          ...
          tabs: [{
            ...
            tpl: '<div><div class="sameDiv" style="margin-bottom:20px"><span class="sameSpan"><i class="iconfont">&#xe9d4;</i></span><input id="' +
              ...
              r +
              '" class="right insertBtnClick">插入</button> <button id="' +
              a +
  ...
  (k.prototype = {
    ...
    _insert: function (e) {
      ...
      if (newNodename == 'BLOCKQUOTE') {
        ...
        t.cmd.do('insertHTML', '<iframe class="entire-line" src="' + e + '"></iframe><p><br></p>');
      }
    },
  }),
  (D.prototype = {
