...
! function () {
    ...
    for (var s = {
            ...
            getLostPoint: function (t) {
                ...
                for (i = 0; i < e; i++)
                    for (u = 0; u < e - 6; u++) t.isDark(i, u) && !t.isDark(i, u + 1) && t.isDark(i, u + 2) && t.isDark(i, u + 3) && t.isDark(i, u + 4) && !t.isDark(i, u + 5) && t.isDark(i, u + 6) && (r += 40);
                for (u = 0; u < e; u++)
                    for (i = 0; i < e - 6; i++) t.isDark(i, u) && !t.isDark(i + 1, u) && t.isDark(i + 2, u) && t.isDark(i + 3, u) && t.isDark(i + 4, u) && !t.isDark(i + 5, u) && t.isDark(i + 6, u) && (r += 40);
    ...
    var d = [
        ...
        p = "svg" === document.documentElement.tagName.toLowerCase() ? g : "undefined" == typeof CanvasRenderingContext2D ? function () {
            ...
            var i = function (t, e) {
                this._bIsPainted = !1, this._android = o(), this._htOption = e, this._elCanvas = document.createElement("canvas"), this._elCanvas.width = e.width, this._elCanvas.height = e.height, this._el = t, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("img"), this._elImage.alt = "Scan me!", this._elImage.style.display = "none", this._bSupportDataURI = null
            };
    ...
    (QRCode = function (t, e) {
        ...
        this._oQRCode = new e(a(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), this._oQRCode.make(),  this._oDrawing.draw(this._oQRCode), this.makeImage()
    ...
    function i(t, e) {
        ...
        i.imageSelector && (i.image = n(i.imageSelector).map(function (t) {
            ...
            function (t, e) {
                ...
                var i = s('<div class="wechat-qrcode"><h4>' + e.wechatQrcodeTitle + '</h4><div class="qrcode" id="QRCode"></div><div class="help">' + e.wechatQrcodeHelper + "</div></div>"),
                    n = a(i[0], "qrcode", "div");
